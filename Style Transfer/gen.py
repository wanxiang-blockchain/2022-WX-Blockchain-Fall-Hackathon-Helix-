...
class CMDStyleTransfer:
    ...
    def _init_model(self):
        ...
        vgg.load_state_dict(torch.load('D:/Weight/vgg19-dcbb9e9d.pth'), strict=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--alpha', type=float, default=1, help='Style and content loss weighting.'
    ...
    parser.add_argument('--r_img', type=str, help='Path to res image') # louis
    parser.add_argument('--im_size', type=int, default=720, nargs='+',
    ...
    stylized_image.save(args.r_img, "PNG")
